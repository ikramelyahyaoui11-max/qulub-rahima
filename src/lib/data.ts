...
export const FAQS = [
  {
    ...
    answer:
      "مؤسسة القلوب الرحيمة مؤسسة متخصصة في تنفيذ المشروعات الخيرية والدينية بالوكالة عن المتبرعين في دول أفريقيا، ونعمل بشفافية كاملة مع توثيق كل عملية.",
  },
  {
  ...
  },
  {
    ...
    answer: "نعمل حاليًا في تنزانيا ومصر وعدة دول أفريقية أخرى، ونعمل على التوسع باستمرار.",
  },
];
